...
FOUNDRY_OPENAI_API_VERSION : str, optional
    Azure OpenAI / Foundry Responses API version. Defaults to
    ``2026-03-01-preview`` (the version documented in the Foundry V2
    research notes for streaming Responses + agent_reference).
"""
...
_DEFAULT_API_VERSION = "2026-03-01-preview"
